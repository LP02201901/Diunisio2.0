...
public interface DiunisioVisitor<T> extends ParseTreeVisitor<T> {
	/**
	 * Visit a parse tree produced by {@link DiunisioParser#inicio}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitInicio(DiunisioParser.InicioContext ctx);
	/**
	 * Visit a parse tree produced by {@link DiunisioParser#clase}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by {@link DiunisioParser#instancia}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
